...
@Service
public class RegionalResultPdf extends ResultPdf {

        private FileStorageService fileStorageService;

        public RegionalResultPdf(FileStorageService fileStorageService) {
                this.fileStorageService = fileStorageService;
        }

        public ByteArrayOutputStream generate(List<ProvisionalRegionalResult> results) throws IOException {
                try (PDDocument document = new PDDocument(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {

                        for (ProvisionalRegionalResult result : results) {
                                // Create an A4 page
        ...
        private void addResultDetailsSection(PDPageContentStream contentStream, PDPage page,
                        ProvisionalRegionalResult result) throws IOException {
                float fontSize = 9;
                ...
                contentStream.showText("Faritra: " + result.getName());
        ...
        private void addTableDetails(PDDocument document, PDPage page, PDPageContentStream contentStream,
                        float startY, ProvisionalRegionalResult result) throws IOException {
                ...
                for (int row = 0; row < result.getDetails().size(); row++) {
                        ...
                        ProvisionalRegionalResultDetails details = result.getDetails().get(row);
