...
@Service
public class MunicipalResultPdf extends ResultPdf {

        private FileStorageService fileStorageService;

        public MunicipalResultPdf(FileStorageService fileStorageService) {
                this.fileStorageService = fileStorageService;
        }

        public ByteArrayOutputStream generate(List<ProvisionalMunicipalResult> results) throws IOException {
                try (PDDocument document = new PDDocument(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {

                        for (ProvisionalMunicipalResult result : results) {
                                // Create an A4 page
        ...
        private void addResultDetailsSection(PDPageContentStream contentStream, PDPage page,
                        ProvisionalMunicipalResult result) throws IOException {
                float fontSize = 9;
        ...
        private void addTableDetails(PDDocument document, PDPage page, PDPageContentStream contentStream,
                        float startY, ProvisionalMunicipalResult result) throws IOException {
                ...
                for (int row = 0; row < result.getDetails().size(); row++) {
                        ...
                        ProvisionalMunicipalResultDetails details = result.getDetails().get(row);
