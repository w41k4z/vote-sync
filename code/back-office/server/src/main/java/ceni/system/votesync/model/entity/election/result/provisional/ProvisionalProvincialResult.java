...
@Entity
@Table(name = "provinces_resultats_provisoires")
@AttributeOverrides({
        @AttributeOverride(name = "divisionId", column = @Column(name = "id_province")),
        @AttributeOverride(name = "name", column = @Column(name = "nom_province")),
        @AttributeOverride(name = "code", column = @Column(name = "code_province"))
})
@Immutable
public class ProvisionalProvincialResult extends ProvisionalElectoralResult {
    ...
    List<ProvisionalProvincialResultDetails> details;
}
